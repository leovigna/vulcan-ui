                    ...
                    <CardBody>
                        <Row className="text-center">
                            <Col className="mb-5 text-left" xs="12">
                                ...
                                <code>.flag-icon-xx</code> (where xx is the ISO 3166-1-alpha-2 code of a country) to an
                                empty span. If you want to have a squared version flag then add the class
