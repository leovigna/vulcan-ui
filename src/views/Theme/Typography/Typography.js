                ...
                <div className="card">
                    ...
                    <div className="card-body">
                        <p>
                            ...
                            <code className="highlighter-rouge">.h6</code> classes are also available, for when you want
                ...
                <div className="card">
                    ...
                    <div className="card-body">
                        <p>
                            ...
                            <code className="highlighter-rouge">.text-truncate</code> class to truncate the text with an
                            ellipsis.
                        </p>
                        <div className="bd-example">
                            <dl className="row">
